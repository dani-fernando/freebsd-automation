...
printf "\n%s============================================%s\n" "$YELLOW" "$RESET"
printf "%s==   Script Instalasi XFCE untuk FreeBSD    ==%s\n" "$GREEN" "$RESET"
printf "%s============================================%s\n\n" "$YELLOW" "$RESET"
...
printf "%sMenginstal: nano vim xfce xorg lightdm%s\n\n" "$GREEN" "$RESET"
pkg install -y nano vim xfce xorg lightdm lightdm-gtk-greeter
...
# 6. Konfigurasi rc.conf untuk driver
...
# Finalisasi
printf "\n%s=================================================%s\n" "$YELLOW" "$RESET"
printf "%sInstalasi XFCE selesai! ✔%s\n" "$GREEN" "$RESET"
printf "%s=================================================%s\n\n" "$YELLOW" "$RESET"
